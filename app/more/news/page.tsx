...
const News = () => {
    ...
    <div className='px-16'>
        ...
        <div className='relative'>
            <div className={`${style.sec1} grid lg:grid-cols-4 md:grid-cols-1 gap-8 transform translate-y-[-200px]`}>
            <div className={`${style.col1} relative`}></div>
            <div className=' bg-[#020032] col-span-3 rounded-[29px] pt-10 pb-16 px-7'>
                <div className='bg-[#EBD778] rounded-[10px] w-[60%] p-3'>
                ...
                <div className='pt-7 font-[Poppins] text-[#EBD778] font-400 lg:text-[20px] sm:text-[15px]'>
            ...
            <div className={`${style.res} text-[#020032] font-400 text-[24px] bg-[#020032] lg:col-span-1 sm:col-span-3 rounded-[50px] pt-6 pb-16 pl-4 pr-5 `}>
                ...
                <div className='flex'>
                    ...
                    <div className='pl-3'>
                        <div className='py-1 px-[5px] mb-2 bg-[#EBD778] rounded-[5px] text-center'>
...
<div className={`${style.sec2}`}></div>
        <div className=' w-[100%] bg-[#020032] pt-12 pl-12 pb-10 mb-10'>
            <div>
                <div className='grid lg:grid-cols-[1fr_1fr_0.1fr_1fr] md:grid-cols-1 gap-5 sm:grid-cols-1 '>
                <div className='flex relative '>
                    <Image className='h-[252px]' src={"/news/cd1c890a6330c4eff07d3f483def5c84.jpeg"} alt='ticket img' width={200} height={100}/>
                ...
                <div className='text-right text-[#EBD778] font-[poppins] pr-12  font-[400]'>
                    <h2 className='text-[40px] pb-16 pr-4 '>November <br />
                    28-11</h2>
                    <p className='text-[18px] leading-[117%] pr-4'>Discover the magic of Aswan with a unique trip that combines history and natural beauty. Enjoy a Nile cruise, explore ancient landmarks, and wander through stunning landscapes. Book your spot now and embark on an unforgettable adventure.
                    4o</p>
                </div>
                
<div className={`${style.line} `}></div>
                <div className=' font-[poppins] font-[400]'>
                    <div className='bg-[#EBD778] py-2 mb-8 px-1 w-[50%] m-auto'>
                        <h3 className='text-[#020032] text-center'>Aswan Trip Program</h3>
                    </div>
...
<div className='grid lg:grid-cols-4 sm:grid-cols-2 gap-5 pb-12'>
    <div>
        <div className='w-[100%]'>
            <Image className='w-[291px] h-[254px]' src={"/news/72b99bf5027cdfd42067c4adffba54f6.png"} alt='img' width={250} height={300}/>
        </div>
    ...
    <div>
        <div className='w-[100%]'>
            <Image className='w-[291px] h-[254px]' src={"/news/dc864d3ea4357050453651dbf94ac32f.jpeg"} alt='img' width={250} height={300}/>
        </div>
    ...
    <div>
        <div className='w-[100%]'>
            <Image className='w-[291px] h-[254px]' src={"/news/a3eaa0dccd576fe44e11ed4a75457707.jpeg"} alt='img' width={250} height={300}/>
        </div>
    ...
    <div>
        <div className='w-[100%]'>
            <Image className='w-[291px] h-[254px]' src={"/news/a6d3e2c99114f33ae3c5fed9bfe40e17.jpeg"} alt='img' width={250} height={300}/>
        </div>
        ...
        <div>
        <div className='relative flex gap-24 w-100%'>
    <h1 className={`${style.sec3} text-[#020032] pb-14 font-[Inika] font-bold lg:text-[40px]`}>What’s new?</h1>
<div className="">
    <button className={`${style.btn} bg-[#020032] text-[#EBD778]  rounded-[5px] py-[10px] px-4 mr-5`}><Link href={"/"} className='font-[poppins] font-[400] text-[14px] '/>Discoveries</button>
    <button className='bg-[#EBD778] text-[#020032]  rounded-[5px] py-[10px] px-10'><Link href={"/"} className='font-[poppins] font-[400] text-[14px] '/>Travel</button>
...
<div>
    ...
    <div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-[180px] mb-16'>
        ...
        <h3 className='text-[30px] font-[700] font-[Inika]  text-[#020032] pt-5'>Discovery of Pharaoh Thutmose II&apos;s Tomb</h3>
        <p className={`text-[24px] font-[400]  text-[#020032] pt-3 font-[poppins]`}>In the Valley of the Kings near Luxor, a joint British-Egyptian archaeological team discovered the tomb of Pharaoh Thutmose II, who ruled Egypt from 1493 to 1479 BC. This marks the first discovery of a pharaoh&apos;s tomb since King Tutankhamun’s tomb was found in 1922
</p>
        </div>
    {/* sec col */}
    ...
    <div className='flex'>
        ...
        <div className='w-[100%]'>
            <Image className='w-[166px] h-[114px] ml-auto' src={"/news/aedc13983eb359e13749165c62c8f3e0.jpeg"} alt='img' width={200} height={200}/>
        </div>
        </div>
        ...
        <div className='w-[100%]'>
            <Image className='w-[166px] h-[114px] ml-auto ' src={"/news/f1e8a889a28d0dcc617a44bc24b0cea7.jpeg"} alt='img' width={200} height={200}/>
        </div>
        </div>
        ...
        <div className='w-[100%]'>
            <Image className='w-[166px] h-[114px]' src={"/news/9d8fa738235d09d3904e6a3b9e2cdd2d.jpeg"} alt='img' width={200} height={200}/>
        </div>
        </div>
